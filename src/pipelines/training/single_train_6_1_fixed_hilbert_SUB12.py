...
SUBJECT = 'SUB12'  # Kalau seluruh subjek gunakan ALL

PROJECT_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../'))
# PATH BARU: Mengarah ke 3 file CSV yang terpisah
TRAIN_CSV = os.path.join(PROJECT_ROOT, 'dataset/SUB12_eq_3_0_train.csv')
VAL_CSV = os.path.join(PROJECT_ROOT, 'dataset/SUB12_eq_3_0_val.csv')
TEST_CSV = os.path.join(PROJECT_ROOT, 'dataset/SUB12_eq_3_0_test.csv')
