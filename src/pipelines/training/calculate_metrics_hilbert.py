...
def main():
    ...
    target_files = [
        "all_eq_3_0_fixed_hilbert_test_predictions_1_1.csv",
        "all_eq_3_0_hilbert_test_predictions_2_1_IndoGPT.csv"
    ]

    for sub in subjects:
        target_files.append(f"{sub}_eq_3_0_hilbert_test_predictions_10_1_IndoGPT.csv")
        target_files.append(f"{sub}_eq_3_0_fixed_hilbert_test_predictions_6_1.csv")
