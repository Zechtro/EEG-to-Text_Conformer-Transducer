...
def main():
    ...
    target_files = [
        "NOISE_BASELINE_all_eq_3_0_fixed_hilbert_test_predictions_1_1.csv",
        "NOISE_BASELINE_all_eq_3_0_hilbert_test_predictions_2_1_IndoGPT.csv"
    ]

    for sub in subjects:
        target_files.append(f"NOISE_BASELINE_{sub}_eq_3_0_hilbert_test_predictions_10_1_IndoGPT.csv")
        target_files.append(f"NOISE_BASELINE_{sub}_eq_3_0_fixed_hilbert_test_predictions_6_1.csv")
