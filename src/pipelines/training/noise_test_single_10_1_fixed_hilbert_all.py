...
BEST_MODEL_PATH = os.path.join(OUTPUT_DIR, f'{SUBJECT}_eq_3_0_hilbert_best_model_2_1_IndoGPT.pt')
OUTPUT_CSV_NAME = f'NOISE_BASELINE_{SUBJECT}_eq_3_0_hilbert_test_predictions_2_1_IndoGPT.csv'
...
def main():
    ...
    # Karena sudah di-check di awal, kita bisa langsung meload bobotnya
