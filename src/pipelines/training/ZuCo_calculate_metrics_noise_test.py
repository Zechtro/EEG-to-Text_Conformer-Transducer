...
def main():
    ...
    TARGET_FILES = [
        'ZuCo_NOISE_BASELINE_ZGW_NR_log-mel_fast_test_predictions_6_1.csv',
        'ZuCo_NOISE_BASELINE_ZGW_NR_hilbert_fast_test_predictions_6_1.csv',
        'ZuCo_NOISE_BASELINE_ZGW_NR_hilbert_GPT2_fast_test_predictions_10_1.csv',
        'ZuCo_NOISE_BASELINE_ZGW_NR_logmel_GPT2frozen_test_predictions.csv',
    ]

    print('=' * 80)
    print('ZuCo — METRIK NOISE BASELINE (WER, BLEU, ROUGE, BERTScore)')
