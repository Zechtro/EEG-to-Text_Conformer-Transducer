...
def load_and_preprocess_dataset(config):
    print(f"\n[STEP 1 & 2] Load pre-split datasets for All Subjects (Train, Val, Test)...")
...
def plot_training_history(history, output_dir):
    ...
    axes[0].set_title(f'Loss (All Subjects - IndoGPT + LogMel)')
    ...
    axes[1].set_title(f'CER (All Subjects - IndoGPT + LogMel)')
...
def main():
    print("=" * 80)
    print(f"EEG-to-Text Training Pipeline (All Subjects | IndoGPT | Log-Mel Spectrogram)")
