...
SUBJECT = 'SUB11'  # Ganti subjek di sini
...
def predict_and_save_csv(model, test_loader, tokenizer, output_dir, device, beam_decoder):
    ...
    csv_path = os.path.join(output_dir, f'{SUBJECT}_eq_3_0_hilbert_test_predictions_10_1_IndoGPT.csv')
...
def plot_training_history(history, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, f'{SUBJECT}_eq_3_0_hilbert_training_history_10_1_IndoGPT.png'), dpi=300)
    plt.close()
...
def main():
    print("=" * 80)
    print(f"EEG-to-Text Training Pipeline (Subject: {SUBJECT} | IndoGPT Decoder)")
    ...
    with open(os.path.join(OUTPUT_DIR, f'{SUBJECT}_eq_3_0_hilbert_training_history_10_1_IndoGPT.json'), 'w') as f:
