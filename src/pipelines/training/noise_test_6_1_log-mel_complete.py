...
CONFIG = {
    'input_dim': 14 * 64, # 14 channel x 64 Mel filterbanks
    'encoder_dim': 128,
    'decoder_dim': 128,
    'joint_dim': 128,
    'vocab_size': None, 
...
def main():
    ...
    print("=" * 80)
    print("PRE-FLIGHT CHECK: MEMERIKSA KELENGKAPAN FILE MODEL & DATA")
    print("=" * 80)
    ...
    for subject in SUBJECTS:
        ...
        if not os.path.exists(tokenizer_path): missing.append("Tokenizer")
