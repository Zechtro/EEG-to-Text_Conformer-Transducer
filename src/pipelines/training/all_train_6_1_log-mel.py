...
VAL_CSV = os.path.join(PROJECT_ROOT, 'dataset/all_eq_3_0_val.csv')
TEST_CSV = os.path.join(PROJECT_ROOT, 'dataset/all_eq_3_0_test.csv')
...
def plot_training_history(history, output_dir):
    ...
    axes[0].set_title(f'Loss History (All Subjects - LogMel Spectrogram)')
    ...
    axes[1].set_title(f'CER History (All Subjects - LogMel Spectrogram)')
...
def main():
    print("=" * 80)
    print(f"EEG-to-Text Training Pipeline (All Subjects | Log-Mel Spectrogram Features)")
    ...
    print("\n" + "=" * 80)
    print(f"✓ FULL TRAINING PIPELINE COMPLETED FOR All Subjects")
    print("=" * 80)
