...
def train(model, train_loader, val_loader, config, device):
    ...
    model_path = os.path.join(
        OUTPUT_DIR, f'ZuCo_{SUBJECT_ID}_NR_hilbert_allch_fast_model_11_1.pt')
...
def predict_and_save_csv(model, train_loader, val_loader, test_loader, tokenizer, device):
    ...
    csv_path = os.path.join(
        OUTPUT_DIR, f'ZuCo_{SUBJECT_ID}_NR_hilbert_allch_fast_test_predictions_11_1.csv')
...
def plot_training_history(history):
    ...
    plt.tight_layout()
    path = os.path.join(
        OUTPUT_DIR, f'ZuCo_{SUBJECT_ID}_NR_hilbert_allch_fast_training_history_11_1.png')
...
def main():
    ...
    tok_path = os.path.join(
        OUTPUT_DIR, f'ZuCo_{SUBJECT_ID}_NR_hilbert_allch_fast_char_tokenizer_11_1.pkl')
    ...
    hist_path = os.path.join(
        OUTPUT_DIR, f'ZuCo_{SUBJECT_ID}_NR_hilbert_allch_fast_training_history_11_1.json')
