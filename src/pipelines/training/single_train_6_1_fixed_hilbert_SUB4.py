...
SUBJECT = 'SUB4'  # Kalau seluruh subjek gunakan ALL
...
VAL_CSV = os.path.join(PROJECT_ROOT, 'dataset/SUB4_eq_3_0_val.csv')
TEST_CSV = os.path.join(PROJECT_ROOT, 'dataset/SUB4_eq_3_0_test.csv')
