...
SUBJECT = 'SUB1'  # Kalau seluruh subjek gunakan ALL
...
def train(model, train_loader, val_loader, tokenizer, config, device):
    ...
    best_model_path = os.path.join(OUTPUT_DIR, f'{SUBJECT}_eq_3_0_fixed_hilbert_best_model_6_6.pt')
    best_cer = float('inf')
...
def predict_and_save_csv(model, test_loader, tokenizer, output_dir, device, beam_decoder):
    ...
    csv_path = os.path.join(output_dir, f'{SUBJECT}_eq_3_0_fixed_hilbert_test_predictions_6_6.csv')
...
def plot_training_history(history, output_dir):
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, f'{SUBJECT}_eq_3_0_fixed_hilbert_training_history_6_6.png'), dpi=300)
    plt.close()
...
def main():
    ...
    tokenizer_path = os.path.join(OUTPUT_DIR, f'{SUBJECT}_eq_3_0_fixed_hilbert_char_tokenizer_6_6.pkl')
    ...
    with open(os.path.join(OUTPUT_DIR, f'{SUBJECT}_eq_3_0_fixed_hilbert_training_history_6_6.json'), 'w') as f:
